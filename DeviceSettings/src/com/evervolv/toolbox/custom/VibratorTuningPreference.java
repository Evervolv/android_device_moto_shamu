...
/**
 * Special preference type that allows configuration of vibrator intensity
 */
public class VibratorTuningPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener {
    ...
    public static final String FILE_PATH         = "/sys/vibrator/pwmvalue";
    ...
    protected void onBindDialogView(View view) {
        ...
        if (WARNING_THRESHOLD > 0) {
            String strWarnMsg = getContext().getResources().getString(
                    R.string.vibrator_warning, strengthToPercent(WARNING_THRESHOLD));
        ...
        mOriginalValue = FileUtil.fileReadOneLine(FILE_PATH);
    ...
    protected void onDialogClosed(boolean positiveResult) {
        ...
        if (positiveResult) {
            ...
            FileUtil.fileWriteOneLine(FILE_PATH, String.valueOf(mOriginalPercent));
        }
    }
    ...
    public static void restore(Context context) {
        ...
        if (value != null) {
            ...
            FileUtil.fileWriteOneLine(FILE_PATH, value);
        }
    }
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        boolean shouldWarn = WARNING_THRESHOLD > 0 && progress >= strengthToPercent(WARNING_THRESHOLD);
        ...
        FileUtil.fileWriteOneLine(FILE_PATH, String.valueOf(percentToStrength(progress)));
